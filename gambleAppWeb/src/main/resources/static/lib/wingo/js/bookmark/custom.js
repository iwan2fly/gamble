...
function submitBookMark() {
	...
	$('#index_var').val(parseInt(index_var)+6);
		...
		var bmColData = '<div class="col-xl-3 col-md-4 xl-50">\
	      <div class="card card-with-border bookmark-card o-hidden"><div class="details-website"><img class="img-fluid" src="/lib/wingo/images/lightgallry/07.jpg" alt="" data-original-title="" title="">\
