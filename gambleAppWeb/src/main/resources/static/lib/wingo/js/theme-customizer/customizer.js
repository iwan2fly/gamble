...
$(document).ready(function() {
    ...
    $(".customizer-color li").on('click', function() {
        ...
        $("#color" ).attr("href", "/lib/wingo/css/"+color+".css" );
    ...
    $('.sidebar-type li , .dashboard-type .dashboard-box').on('click', function () {
        ...
        switch (type) {
            ...
            case 'normal-sidebar':{
                ...
                $(".logo-wrapper").find('img').attr('src', '/lib/wingo/images/logo/logo.png');
