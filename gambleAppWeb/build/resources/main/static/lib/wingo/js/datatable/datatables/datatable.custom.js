$(document).ready(function() {
    ...
    $('#advance-8').DataTable({
        "language": {
            "url": "/lib/wingo/json/German.json"
        }
    });
    $('#advance-9').DataTable({
        "searching": false,
    ...
    $('#data-source-2').DataTable({
        "ajax": '/lib/wingo/ajax/arrays.txt'
    });
    var dataSet = [
    ...
    $('#data-source-4').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "/lib/wingo/json/server-side.json"
    } );
    ...
    $('#ajax-data-object').DataTable({
        "ajax": "/lib/wingo/ajax/object.txt",
        "columns": [{
            "data": "name"
        }, {
            "data": "position"
    ...
    $('#ajax-data-nested-object').DataTable({
        "processing": true,
        "ajax": "/lib/wingo/ajax/object_nested.txt",
        "columns": [{
            "data": "name"
            }, {
                "data": "hr.position"
    ...
    $('#orthogonal-data').DataTable({
        ajax: "/lib/wingo/ajax/orthogonal.txt",
        columns: [{
            data: "name"
        }, {
            data: "position"
    ...
    $('#server-side-datatable').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "/lib/wingo/ajax/server-processing.php"
    });
    ...
    $('#datatable-http').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "/lib/wingo/ajax/server-processing.php",
            data: function(d) {
                d.myKey = "myValue";
            }
        },  
