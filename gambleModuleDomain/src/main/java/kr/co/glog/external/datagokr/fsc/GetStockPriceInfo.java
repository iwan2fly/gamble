...
public class GetStockPriceInfo {
    ...
    public ArrayList<GetPriceStockInfoResult> getStockPriceInfoList( Document document ) {

        ArrayList<GetPriceStockInfoResult> itemList = new ArrayList<GetPriceStockInfoResult>();
        ...
        try {
            ...
            for ( int i = 0; i < itemArray.size(); i++ ) {
                ...
                GetPriceStockInfoResult getPriceStockInfoResult = objectMapper.readValue( item.toString(), GetPriceStockInfoResult.class );
                itemList.add( getPriceStockInfoResult );
            }
